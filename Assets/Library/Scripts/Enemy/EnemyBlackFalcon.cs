...
{
    public class EnemyBlackFalcon : EnemyBase
    {
        ...
        public override void SetUpStateMachine()
        {
            ...
            enemyChaseState = new EnemyStateChaseDash1(this, _stateMachine);
            enemyAttackState = new EnemyStateAttackDash(this, _stateMachine);
            enemyRetreatState = new EnemyStateRetreatDash(this, _stateMachine);
